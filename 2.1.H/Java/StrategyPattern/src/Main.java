...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        List<Individual> individuals = new ArrayList<>(Arrays.asList(
            ...
            new Individual(3, "Male", 22, "Intro text 3", Arrays.asList("gaming", "cycling"), new Coordinate(3.6370, 3.2232)),
        ...
        matchSystem.match(new Reverse(new HabitBased()), targetIndividual);
        System.out.print("Reverse HabitBased: ");
        System.out.println(targetIndividual.getIndividual().getId());
